...
CAUC01=float(input('MAP3: Caucasian race (1: yes, 0: no, 0: unsure): '))
ARR01=float(input('MAP20: Arrythmia (1: yes, 0: no, 0: unsure): '))            
AGE40=float(input('MAP2: Maternal age > 40 (1: yes, 0: no, 0: unsure): '))                        
DIAB01=float(input('MAP4: Any form of diabetes (1: yes, 0: no, 0: unsure): '))            
DEP01=float(input('MAP5: Clinical depression (1: yes, 0: no, 0: unsure): '))            
ENDO01=float(input('MAP6: Endometriosis (1: yes, 0: no, 0: unsure): '))       
HF01=float(input('MAP7: Heart failure (1: yes, 0: no, 0: unsure): '))       
HD01=float(input('MAP8: Heart disease (1: yes, 0: no, 0: unsure): '))       
HYP01=float(input('MAP9: Hypertension (1: yes, 0: no, 0: unsure): '))       
LUP01=float(input('MAP10: Lupus (1: yes, 0: no, 0: unsure): '))       
MINFERT01=float(input('MAP11: Maternal infertility (1: yes, 0: no, 0: unsure): '))       
PLAC01=float(input('MAP12: Placental abruption (1: yes, 0: no, 0: unsure): '))       
POLY01=float(input('MAP13: Polyhydramnios (1: yes, 0: no, 0: unsure): '))       
PREC01=float(input('MAP14: Preeclampsia(1: yes, 0: no, 0: unsure): '))       
LUP01=float(input('MAP15: Lupus (1: yes, 0: no, 0: unsure): '))       
...
print('Hemorrhage:')                         
ASTH01=float(input('MAP21: Cervical cerclage (1: yes, 0: no, 0: unsure): '))

if PAR401==1:
    FIRSTDEL01=0.0
else:
    FIRSTDEL01=float(input('MAP22: First delivery (1: yes, 0: no, 0: unsure): '))                  
        
Ante_h_coef= -3.1603 + AGE40*0.3511 + ARR01*0.6196 + CRET01*2.1030 + DIAB01*0.1620 + ENDO01*1.1456 + HF01*1.6663 + HD01*0.0601 + HYP01*0.4057 + MGEST01*0.8440 + PAR401*0.4142 + PCES01*0.0443 + PLAC01*0.9229 + POLY01*0.5494 + PREC01*0.6010 + PREV01*1.9011 + RENF01*1.2820 + SICKL01*0.1667 + RENALA01*0.3970 + MINFERT01*0.0623 + FIRSTDEL01*0.0985
